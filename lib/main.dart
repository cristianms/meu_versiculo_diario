...
class _MyHomePageState extends State<MyHomePage> {
  Versiculo? versiculo;
  final listaVersiculos = <Versiculo>[
    Versiculo(
    ...
    Versiculo(
      texto: 'Porque Deus amou o mundo de tal maneira que deu seu Filho unigênito para todo aquele que nele crê não pereça mas tenha a ,vida eterna.',
      livro: 'João',
      versiculo: '3:16',
    ),
    Versiculo(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Meu Versículo Diário'),
      ),
      body: Padding(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          final random = Random();
          final indexRandom = random.nextInt(listaVersiculos.length - 1);
          setState(() {
            versiculo = listaVersiculos[indexRandom];
          });
        },
        tooltip: 'Buscar novo versículo',
